...
const NEWS_FEEDS: Record<string, NewsFeed> = {
  main: {
    ...
    headlines: [
      ...
      {title: 'Heavy rain likely inland Thursday evening', comments: 512},
      {title: 'National squad names 23 players', comments: 1240},
      {
        title: 'Empty-home renovation grant opens today',
        comments: 63,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Regulator asks carriers to publish delivery-window accuracy', comments: 95},
    ],
    focal: {
  ...
  domestic: {
    ...
    headlines: [
      {
        title: 'Empty-home grant caps at 3,000 households',
        comments: 148,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'School lunch program adds two districts', comments: 96},
      {title: 'Night bus 88 becomes permanent', comments: 58},
      {title: 'Flu shot appointments open for adults 65+', comments: 33},
      {title: 'City marathon lottery draws 142,000 entries', comments: 271},
      {title: 'Coastal wind farm clears environmental review', comments: 149},
      {title: 'Library drops overdue fines on children’s books', comments: 24},
      {title: 'Rent relief for public housing cuts paperwork', comments: 37},
    ],
    focal: {
  ...
  world: {
    ...
    headlines: [
      ...
      {title: 'Container backlog expected to clear in 11 days', comments: 77},
      {title: 'Cross-border rail ends first month at 80% of forecast', comments: 61},
      ...
      {title: 'Two cities sign a plan to cool public squares', comments: 38},
      {title: 'Undersea cable repair finishes a week early', comments: 112},
    ],
    focal: {
  ...
  economy: {
    ...
    headlines: [
      {
        title: 'Grocery chain buys 210 franchise stores',
        comments: 186,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Parcel carrier posts first profit in three years', comments: 54},
      ...
      {title: 'Retail wage floor rises 4.1% in a sector deal', comments: 341},
  ...
  tech: {
    ...
    headlines: [
      {
        title: 'Seawater cooling cuts a data hall’s power draw 31%',
        comments: 141,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Transit app ships offline timetables', comments: 71},
      {title: 'Open forecast dataset adds 40 years of readings', comments: 46},
      {title: 'Handset maker promises seven years of security updates', comments: 258},
      {title: 'Rail operator publishes a delay-prediction model', comments: 134},
  ...
  sports: {
    ...
    headlines: [
      {
        title: 'Harborview holds on 2–1 for a fourth straight road win',
        comments: 486,
        flag: {label: 'BREAKING', tone: 'breaking'},
      },
      ...
      {title: 'Marathon course reroutes around viaduct work', comments: 57},
      {title: 'League approves a 26-team format', comments: 613},
      {title: 'Cyclist wins the hill stage on a 25-mile solo break', comments: 88},
      {title: 'Basketball team signs a center to a two-year deal', comments: 44},
  ...
  life: {
    ...
    headlines: [
      ...
      {title: 'A gardener’s case for planting hard corners last', comments: 36},
  ...
  local: {
    ...
    headlines: [
      {
        title: 'Water main switchover in the Harbor District',
        comments: 31,
        flag: {label: 'NEW', tone: 'new'},
      },
      ...
      {title: 'City offices to open two Saturdays a month', comments: 67},
      {title: 'Paper recycling moves to the 2nd and 4th Tuesdays in October', comments: 23},
