...
const NEWS_FEEDS: Record<string, NewsFeed> = {
  main: {
    ...
    headlines: [
      {
        title: 'Transit adds 14 late-night bus trips',
        comments: 238,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Grocery prices ease a third month', comments: 176},
      {title: 'Seawater cooling cuts power draw 31%', comments: 87},
      {
        title: 'Viaduct repair finishes nine weeks early',
        comments: 41,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Heavy rain inland from Thursday night', comments: 512},
      {title: 'National squad names 23 players', comments: 1240},
      {
        title: 'Empty-home renovation grant opens',
        comments: 63,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Regulator asks carriers to publish accuracy', comments: 95},
    ],
    focal: {
  ...
  domestic: {
    ...
    headlines: [
      {
        title: 'Empty-home grant caps at 3,000',
        comments: 148,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'School lunch program adds two districts', comments: 96},
      {title: 'Night bus 88 becomes permanent', comments: 58},
      {title: 'Flu shot appointments open for over-65s', comments: 33},
      {title: 'City marathon lottery draws 142,000 entries', comments: 271},
      {title: 'Coastal wind farm clears final review', comments: 149},
      {title: 'Library drops fines on children’s books', comments: 24},
      {title: 'Rent relief for housing cuts paperwork', comments: 37},
    ],
    focal: {
  ...
  world: {
    ...
    headlines: [
      {
        title: 'Port strike ends in a staffing deal',
        comments: 204,
        flag: {label: 'BREAKING', tone: 'breaking'},
      },
      {title: 'Container backlog to clear in 11 days', comments: 77},
      {title: 'Cross-border rail ends month at 80%', comments: 61},
      {title: 'Drought monitor lowers its alert level', comments: 45},
      {title: 'Central bank holds rates, trims outlook', comments: 302},
      {title: 'Wheat exporters lift shipment estimates', comments: 58},
      {title: 'Two cities sign a shared cooling plan', comments: 38},
      {title: 'Undersea cable repair finishes early', comments: 112},
    ],
    focal: {
  ...
  economy: {
    ...
    headlines: [
      {
        title: 'Grocery chain buys 210 franchises',
        comments: 186,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Parcel carrier posts its first profit', comments: 54},
      {title: 'Regional lender reopens 12 branches', comments: 89},
      {title: 'Airline adds a second daily Harborview flight', comments: 27},
      {title: 'Chip packager commits $600M inland', comments: 163},
      {title: 'Retail wage floor rises 4.1% in deal', comments: 341},
      {title: 'Electricity rebate extended for winter', comments: 205},
      {title: 'Long-term yields edge up on rebalancing', comments: 118},
    ],
    focal: {
  ...
  tech: {
    ...
    headlines: [
      {
        title: 'Seawater cooling cuts hall power 31%',
        comments: 141,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Transit app ships offline timetables', comments: 71},
      {title: 'Open forecast dataset adds 40 years', comments: 46},
      {title: 'Handset maker promises 7 years of updates', comments: 258},
      {title: 'Rail operator publishes its delay model', comments: 134},
      {title: 'Storage prices fall a fourth consecutive quarter', comments: 63},
      {title: 'Two universities share a network testbed', comments: 19},
      {title: 'Smaller satellites cut launch costs 30%', comments: 88},
    ],
    focal: {
  ...
  sports: {
    ...
    headlines: [
      {
        title: 'Harborview hold on 2–1 for 4th',
        comments: 486,
        flag: {label: 'BREAKING', tone: 'breaking'},
      },
      {title: 'Fall series squad leaves out two veterans', comments: 1240},
      {title: 'Swimmer takes the 200m record by 0.34s', comments: 92},
      {title: 'Marathon course reroutes at the viaduct', comments: 57},
      {title: 'League approves a 26-team format', comments: 613},
      {title: 'Cyclist wins the hill stage on a 25-mile break', comments: 88},
      {title: 'Basketball side signs a two-year center', comments: 44},
  ...
  life: {
    ...
    headlines: [
      {
        title: 'The two-gallon pantry, cooking for one',
        comments: 64,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'A gardener’s case for the hard corner', comments: 36},
      {title: 'Five short hikes you can reach on a day pass', comments: 74},
      {title: 'When the museum dropped timed entry', comments: 51},
      {title: 'Sleep clinic publishes a shift-work guide', comments: 118},
      {title: 'The repair café that fixed 1,900 kettles', comments: 82},
      {title: 'A reading list for the long commute', comments: 29},
      {title: 'Storage, in a 22-square-foot kitchen', comments: 47},
    ],
    focal: {
  ...
  local: {
    ...
    headlines: [
      {
        title: 'Water main switchover in Harbor District',
        comments: 31,
        flag: {label: 'NEW', tone: 'new'},
      },
      {title: 'Northline crossing to be raised', comments: 58},
      {title: 'Civic Hall closes for renovation through March', comments: 44},
      {title: 'Beach cleanup seeks 300 volunteers', comments: 12},
      {title: 'City office windows open two Saturdays', comments: 67},
      {title: 'Paper recycling moves to two Tuesdays', comments: 23},
...
const LOCAL_NOTICES: readonly string[] = [
  ...
  'New fee for records at kiosks',
  'City pool renovation starts October 20',
  'Bookmobile adds two more stops',
  'Preschool signups open Nov 4',
  'Screening van schedule posted',
  'Bike permit results on the 25th',
  'Street tree pruning to December',
];
...
const QA_THREADS: readonly {title: string; answers: number; isOpen: boolean}[] =
  [
    ...
    {
      title: 'Can I apply if the deed is in my parent’s name?',
      answers: 9,
      isOpen: true,
    },
    {
...
const RANKINGS: Record<string, readonly RankEntry[]> = {
  read: [
    {title: 'Late-night service on six routes', metric: '84K'},
    {title: 'Why grocery prices kept falling', metric: '61K'},
    {title: 'The empty-home grant, in full', metric: '55K'},
  ...
  shared: [
    ...
    {title: 'The café that fixed 1,900 kettles', metric: '9,800'},
    {title: 'Six walks that end at a bakery', metric: '8,100'},
    {title: 'The night shift moving the trains', metric: '7,600'},
    {title: 'Library drops kids’ book fines', metric: '6,200'},
  ...
  discussed: [
    ...
    {title: 'Seven years of updates, promised', metric: '258'},
    {title: 'Grocery prices and supply', metric: '214'},
  ],
};
